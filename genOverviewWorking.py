...
allYears = ["2019Q1_2019-01-08_2019-04-02\\transactionsCatagorized.csv",
			...
			"2022Q2_2022-04-06_2022-06-30\\transactionsCatagorized.csv",
			"2022Q3_2022-07-01_2022-10-05\\transactionsCatagorized.csv",
			"2022-10-07_2023-01-04\\transactionsCatagorized.csv"]
...
stackGraphs("Food and Drink", accountDF.loc[(accountDF.catagory == "food") | (accountDF.catagory == "drink")].copy(), separation="month")
...
for i, name in enumerate(topNameList, start=1):
	...
	print("\n-----Start-------\n")
	genLineChartV2("#%s: %s" % (i, name), dataSample, weekSpendRate=True)  # Just transaction info
